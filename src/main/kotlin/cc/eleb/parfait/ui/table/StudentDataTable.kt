...
class StudentDataTable : JTable(StudentTableModel()) {
    init {
        ...
        this.getColumnModel().getColumn(2).cellEditor =
            DefaultCellEditor(JComboBox(DefaultComboBoxModel(arrayOf("未知", "男", "女"))))
        this.getColumnModel().getColumn(3).cellEditor =
            DefaultCellEditor(JComboBox(DefaultComboBoxModel(arrayOf("在籍", "毕业"))))
    }
