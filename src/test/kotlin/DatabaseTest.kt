...
class DatabaseTest : KoinTest {
    ...
    fun `GPA标准插入`() = runBlocking {
        ...
        val testScores = listOf(
            ScoreDTO(name = "测试课程1", type = CourseType.DEFAULT, exam = "考试", credit = 3, score = 95.0, gpa = true),
            ScoreDTO(name = "测试课程2", type = CourseType.DEFAULT, exam = "考试", credit = 4, score = 85.0, gpa = true),
